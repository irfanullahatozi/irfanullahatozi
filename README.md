...
I am a Senior Full Stack & Backend Engineer with **8+ years of experience** building scalable web and mobile applications, enterprise systems, ERPs, and microservices.

I specialize in:
- Backend architecture (Node.js, Django, Python)
- REST APIs & microservices
- Database design & optimization
- Full-stack development (MERN / PERN)

Currently, I am transitioning into **Cybersecurity Engineering**, focusing on:
- 🛡️ SOC Engineering
- 🔍 Threat Intelligence (OpenCTI / MISP)
- ⚙️ Security Automation (Python-based pipelines)
- 📊 SIEM & log analysis systems
...
### 🛡️ Cybersecurity (Learning & Building)
![OpenCTI](https://img.shields.io/badge/OpenCTI-Threat%20Intel-blue)
![MISP](https://img.shields.io/badge/MISP-Threat%20Sharing-orange)
...
- 📡 SIEM Engineering (Wazuh, ELK Stack)  
- 🤖 Security Automation using Python  
- 🌐 Network Security & IDS/IPS (Suricata, Zeek)  
...
- Transition into Cybersecurity Engineering
- Become expert in SOC & Threat Intelligence systems
- Build AI-driven security automation tools
...
I love building systems that not only **scale applications** but also **protect them from real-world attacks**.
